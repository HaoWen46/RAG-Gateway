...
class RetrievalServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.Index = channel.unary_unary(
                '/retrieval.v1.RetrievalService/Index',
                request_serializer=retrieval_dot_v1_dot_retrieval__pb2.IndexRequest.SerializeToString,
                response_deserializer=retrieval_dot_v1_dot_retrieval__pb2.IndexResponse.FromString,
                _registered_method=True)
...
def add_RetrievalServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'Index': grpc.unary_unary_rpc_method_handler(
                    servicer.Index,
                    request_deserializer=retrieval_dot_v1_dot_retrieval__pb2.IndexRequest.FromString,
                    response_serializer=retrieval_dot_v1_dot_retrieval__pb2.IndexResponse.SerializeToString,
            ),
    }
...
class RetrievalService(object):
    ...
    def Index(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/retrieval.v1.RetrievalService/Index',
            retrieval_dot_v1_dot_retrieval__pb2.IndexRequest.SerializeToString,
            retrieval_dot_v1_dot_retrieval__pb2.IndexResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
